...
def create_app():
    ...
    def set_security_headers(response):
        ...
        response.headers["Content-Security-Policy"] = (
            ...
            "connect-src 'self' https://api.mercadopago.com https://open.tiktokapis.com https://www.tiktok.com; "
            "frame-src https://www.mercadopago.com.br https://mercadopago.com.br https://www.tiktok.com; "
            "form-action 'self' https://www.tiktok.com; "
            "object-src 'none'; "
            "base-uri 'self';"
        )
        return response
