...
def create_app():
    ...
    def set_security_headers(response):
        ...
        response.headers["Content-Security-Policy"] = (
            "default-src 'self'; "
            "script-src 'self' 'unsafe-inline' https://sdk.mercadopago.com https://www.tiktok.com https://accounts.tiktok.com "
            "https://sf-security.ibytedtos.com https://*.tiktokcdn.com https://*.ttwstatic.com https://mon.tiktokv.com; "
            "script-src-elem 'self' 'unsafe-inline' https://sdk.mercadopago.com https://www.tiktok.com https://accounts.tiktok.com "
            "https://sf-security.ibytedtos.com https://*.tiktokcdn.com https://*.ttwstatic.com https://mon.tiktokv.com; "
            "style-src 'self' 'unsafe-inline' https://*.ttwstatic.com https://*.tiktokcdn.com; "
            "img-src 'self' data: blob: https:; "
            "connect-src 'self' https://api.mercadopago.com https://open.tiktokapis.com https://www.tiktok.com https://accounts.tiktok.com "
            "https://sf-security.ibytedtos.com https://*.tiktokcdn.com https://*.ttwstatic.com https://mon.tiktokv.com; "
